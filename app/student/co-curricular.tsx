...
export default function TechnicalActivitiesScreen() {
  ...
  const loadData = async () => {
    try {
      ...
      // Filter for co-curricular only if we share the table
      ...
      const academicYear = getAcademicYearFromSemester(semester);
        ...
        if (certificateUri && (certificateUri.startsWith('file://') || certificateUri.startsWith('blob:') || certificateUri.startsWith('data:'))) {
            const uploadedUrl = await uploadToCloudinary(
              ...
              'intership_gfm_record/cocurricural_gfm_record'
            );
        ...
        Alert.alert('Success', 'Co-curricular activity added successfully!');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Technical Activities</Text>
        <TouchableOpacity
      ...
      <ScrollView style={styles.content}>
        ...
        {showForm && (
          <View style={styles.formCard}>
            <Text style={styles.formTitle}>Add Technical Activity</Text>
            <Text style={styles.formSubtitle}>
              Workshops, Seminars, Hackathons, Certifications, etc.
            </Text>
            ...
            <TextInput
              ...
              placeholder="e.g., Web Development Workshop, AI Hackathon"
            />
            ...
            <TextInput
              ...
              placeholder="Brief description of the technical activity"
              multiline
              numberOfLines={4}
              maxLength={500}
            />
        ...
        <View style={styles.listCard}>
          <Text style={styles.listTitle}>Technical Activities ({activities.length})</Text>

          {activities.length === 0 ? (
            <View style={styles.emptyState}>
              <Text style={styles.emptyEmoji}>💻</Text>
              <Text style={styles.emptyText}>No technical activities added yet</Text>
            </View>
          ) : (
                ...
                <View style={styles.activityHeader}>
                    ...
                    <View style={styles.badgeGroup}>
                      ...
                      <View style={styles.technicalBadge}>
                        <Ionicons name="code-slash" size={16} color="#2196F3" />
                        <Text style={styles.technicalBadgeText}>Technical</Text>
                      </View>
                    </View>
                  </View>
